...
void save_game_state(const Mario&, const BoardElements&, Barell*, FallingBarell&, TimeVariables&);
void load_barells_from_file(Barell* barells, FallingBarell& flying_barell, TimeVariables&);